...
public class MessageRVAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<com.touchizen.drawerwithbottomnavigation.ui.chatbot.MessageModal> messageModalArrayList;
    private Context context;

    //constructor class.
    public MessageRVAdapter(ArrayList<com.touchizen.drawerwithbottomnavigation.ui.chatbot.MessageModal> messageModalArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        com.touchizen.drawerwithbottomnavigation.ui.chatbot.MessageModal modal = messageModalArrayList.get(position);
