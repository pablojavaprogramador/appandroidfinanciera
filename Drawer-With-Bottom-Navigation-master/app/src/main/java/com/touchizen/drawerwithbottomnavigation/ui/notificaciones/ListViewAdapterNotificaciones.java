...
public class ListViewAdapterNotificaciones extends BaseAdapter {
    // Declare Variables
    NotificacionesFragment context;
    String[]fechaHoras;
    String[] titulos;
    String[] mensajes;
    int[] imagenes;
    ...
    public ListViewAdapterNotificaciones(NotificacionesFragment context, String[] fechaHora, String[] titulo, String[] mensaje, int[] imagenes, LayoutInflater inflater) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      // inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        View itemView = inflater.inflate(R.layout.list_row_notificaciones, parent, false);
