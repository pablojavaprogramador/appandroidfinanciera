...
public class ListViewAdapterTarjetasRegalo extends BaseAdapter {
    // Declare Variables
    TarjetasRegaloFragment context;
    String[] titulos;
    String[] mensajes;
    int[] imagenes;
    LayoutInflater inflater;

    public ListViewAdapterTarjetasRegalo(TarjetasRegaloFragment context, String[] titulo, String[] mensaje, int[] imagenes, LayoutInflater inflater) {
